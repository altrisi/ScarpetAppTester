...
public class ScarpetAPI {
	...
	public TestValue create_test(Context context, String name, TestSubject subject, Value... callValues) {
		...
		return TestValue.createNewTest(name, subject, calls[0], calls[1], calls[2], calls[3]);
	}
